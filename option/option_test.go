...
func TestOptionGetOrElse(t *testing.T) {
	...
	is.Equal(42, Some(42).GetOrElse(21))
	is.Equal(21, None[int]().GetOrElse(21))
}
...
func TestOptionMatch(t *testing.T) {
	...
	is.Equal(Option[int]{value: 0, isPresent: true}, opt2)
}
...
func TestOptionMapNone(t *testing.T) {
	...
	opt1 := Some(21).MapNone(func() (int) {
		is.Fail("should not be called")
		return 42
	})
	opt2 := None[int]().MapNone(func() (int) {
		return 42
	})
